...
const TypeSection = ()=>{
    ...
    return (
        <div>
            ...
            <div className="max-lg:flex max-lg:flex-wrap grid lg:grid-cols-5 gap-2">
                {hotelTypes.map((type)=>(
                    <label className={typeWatch === type
                                    ?"cursor-pointer bg-blue-300 text-sm rounded-full px-4 py-2 font-semibold"
                                    :"cursor-pointer bg-gray-300 hover:bg-blue-300 text-sm rounded-full px-4 py-2 font-semibold"}>
