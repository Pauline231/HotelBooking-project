...
const DetailsSection = ()=>{
    ...
    return(
        <div className="flex flex-col gap-4">
            <h1 className="text-3xl font-bold font-palanquin mb-3">Add Hotel</h1>   
            <label className="text-gray-700 text-sm font-bold  font-montserrat flex-1">Name
            ...
            <label className="text-gray-700 text-sm font-bold  font-montserrat flex-1">Country
            ...
            <label className="text-gray-700 text-sm font-bold  font-montserrat flex-1">City
            ...
            <label className="text-gray-700 text-sm font-bold  font-montserrat flex-1">Description
            ...
            <label className="text-gray-700 text-sm font-bold  font-montserrat max-w-[50%]">Price Per Night
            ...
            <label className="text-gray-700 text-sm font-bold  font-montserrat max-w-[50%]">Star Rating
